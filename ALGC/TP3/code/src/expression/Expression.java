...
public abstract class Expression {
	...
	private int construireROBDD(ROBDD G, List<String> atomes_ordonnes){
		...
		fin=fin.remplace(p, false);
		n1= fin.construireROBDD(G, atomes_ordonnes.subList(1, atomes_ordonnes.size()));
		
		finbis=finbis.remplace(p, true);
		n2=fin.construireROBDD(G, atomes_ordonnes.subList(1, atomes_ordonnes.size()));
