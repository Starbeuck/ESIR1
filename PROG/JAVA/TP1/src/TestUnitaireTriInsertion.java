...
public class TestUnitaireTriInsertion
{
  ...
  public void tableau_quelconque()
  {
    ...
    int [] a_tester = {
      25, 15, 482, 10, 15, 778, 43, 77, 88, 29, 15, 725, 4, 15, 738, 13, 15,
      823, 15, 15, 802, 19, 15, 830, 31, 15, 802, 35, 22, 22, 6, 15, 802, 29, 12,
      12, 9, 21, 48, 27, 13, 579, 5, 13, 609, 8, 13, 617, 12, 13, 650, 2, 13, 669, 
      14, 13, 650, 11, 13, 702, 51, 88, 88, 20, 13, 797, 10, 10, 55, 23, 13, 805, 24, 
      13, 813, 28, 13, 848, 18, 13, 871, 21, 13, 896, 30, 13, 921, 3, 13, 933, 1, 13, 946, 7, 14, 45, 0
    };
    ...
    // trier le tableau a_tester
    AppelAlgoTri(a_tester);
    TriDicho.afficherTableau(a_tester, a_tester.length);
